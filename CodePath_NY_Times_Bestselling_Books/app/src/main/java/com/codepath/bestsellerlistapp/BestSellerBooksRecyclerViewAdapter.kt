 ...
 */
class BestSellerBooksRecyclerViewAdapter(private val books: List<BestSellerBook>,
                                         private val mListener: OnListFragmentInteractionListener?) : RecyclerView.Adapter<BestSellerBooksRecyclerViewAdapter.BookViewHolder>() {
    ...
    inner class BookViewHolder(val mView: View) : RecyclerView.ViewHolder(mView) {
        ...
        val mBookBtn: Button = mView.findViewById<Button>(id.buy_button) as Button
    ...
    override fun onBindViewHolder(holder: BookViewHolder, position: Int) {
        ...
        holder.mBookBtn.setOnClickListener {
